...
void Settings::load() {
  QFile cfgFile(getDataDir().absoluteFilePath(QCoreApplication::applicationName() + "ccm.cfg"));
  ...
  defaultNodesList << "node.cryptocoupons.market:9356" << "node1.cryptocoupons.market:9356"; //
