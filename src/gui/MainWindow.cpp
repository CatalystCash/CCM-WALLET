...
void MainWindow::setMainWindowTitle() {
  setWindowTitle(QString(tr("CCM Wallet %1")).arg(Settings::instance().getVersion()));
}
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at cryptocoupons.market in Help section"));
...
void MainWindow::walletOpened(bool _error, const QString& _error_text) {
  if (!_error) {
	...
	setWindowTitle(QString(tr("%1 - CCM Wallet %2")).arg(Settings::instance().getWalletFile()).arg(Settings::instance().getVersion()));
...
void MainWindow::walletClosed() {
  ...
  setWindowTitle(QString(tr("CCM Wallet %2")).arg(Settings::instance().getVersion()));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("CCM Wallet %1")).arg(Settings::instance().getVersion());
